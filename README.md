...
```lua
local Library = loadstring(game:GetService("HttpService"):GetAsync("https://github.com/UnknownkellyMCsudo/Fluent-Renewed/releases/download/v1.0.2.2/Fluent.luau", true))()
```
